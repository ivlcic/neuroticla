...
```
{
  ...
  "created": "2023-12-13T20:09:52.182Z",  // The date and time when an article was retrieved
...
An index file (EMMA_1mio-v1.0-index.cvs) was constructed from the corpus for easier:
- Navigation
- Sub-corpus selection
- Statistic analysis

Lastly, the tag_industries_map.csv is a mapping from clients (actually clients' topic groups) to a selected industry/domain.
